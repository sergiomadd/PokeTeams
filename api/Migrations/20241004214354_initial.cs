    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Identifier = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegulationIdentifier = table.Column<string>(type: "nvarchar(2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.RegulationIdentifier,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnonPlayer = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    TournamentNormalizedName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Move1Identifier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Move2Identifier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Move3Identifier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Move4Identifier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ivs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    evs = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TagsIdentifier = table.Column<string>(type: "nvarchar(32)", nullable: false),
